...
DEFAULT_MENUS = [
    ...
    },
    {
        ...
        "children": [
            ...
            {"code": "system:component", "name": "组件管理", "icon": "Appstore", "path": "/system/components", "component": "monitor/component/index", "permission_code": "monitor:component:list", "menu_type": "menu", "sort_order": 6, "allowed_paths": '["GET:/djangoadminx/api/v1/common/health/", "GET:/djangoadminx/api/v1/common/cache/stats/", "POST:/djangoadminx/api/v1/common/cache/clear/", "GET:/djangoadminx/api/v1/cluster/nodes/overview/", "GET:/djangoadminx/api/v1/cluster/components/", "POST:/djangoadminx/api/v1/cluster/components/*/set_upgrade/", "POST:/djangoadminx/api/v1/cluster/components/*/cancel_upgrade/", "POST:/djangoadminx/api/v1/files/upload/", "/djangoadminx/api/v1/files/*"]'},
...
PLATFORM_PERMISSIONS = [
    ...
    {"app_label": "monitor", "codename": "monitor:component:list", "name": "组件管理"},
